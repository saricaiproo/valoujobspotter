...
class LinkedInScraper(BaseScraper):
    ...
    def build_search_url(self, keyword, location='Montreal'):
        ...
        # f_TPR=r86400 = last 24h, f_WT=2 = remote
    ...
    def parse_listing(self, soup):
        ...
        for card in cards:
            try:
                title_el = card.select_one('h3.base-search-card__title, a.base-card--link span, h3.job-search-card__title')
                if not title_el:
                    continue

                title = title_el.get_text(strip=True)

                link_el = card.select_one('a.base-card--link, a.base-search-card__full-link, a[data-tracking-control-name]')
                ...
                company_el = card.select_one('h4.base-search-card__subtitle, a.base-search-card__subtitle, span.job-search-card__company-name')
